...
var swipe_choice = parseInt(prompt("Will you swipe left or right?: (1)Right (2)Left"));
...
var food_choice = parseInt(prompt("What kind of food will you choose?: (1)Italian (2)Curry (3)Pub grub"));
...
var pay_choice = parseInt(prompt("What will you do?: (1)Say you left your wallet at home. (2)Offer to pay."));
